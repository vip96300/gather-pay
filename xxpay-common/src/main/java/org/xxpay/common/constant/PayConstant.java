...
public class PayConstant {
    ...
    public final static String PAY_CHANNEL_QQ = "QQ";                            // QQ钱包支付
    public final static String PAY_CHANNEL_JD = "JD";                            // 京东支付

    public final static String CHANNEL_NAME_WX = "WX";                // 渠道名称:微信
    public final static String CHANNEL_NAME_ALIPAY = "ALIPAY";        // 渠道名称:支付宝
    public final static String CHANNEL_NAME_XTENPAY = "XTENPAY";        // 渠道名称:xtenpay
    ...
    public static class TenConstant {
        public final static String TRADE_TYPE_WX_H5 = "WX_H5";              // 微信H5支付
        public final static String TRADE_TYPE_WX_MP = "WX_MP";              // 微信公众号支付
        public final static String TRADE_TYPE_WX_QR = "WX_QR";              // 微信二维码支付
        public final static String TRADE_TYPE_WX_SC = "WX_SC";              // 微信扫码支付
        public final static String TRADE_TYPE_AL_QR = "AL_QR";              // 支付宝二维码支付
        public final static String TRADE_TYPE_AL_SC = "AL_SC";              // 支付宝扫码支付
        public final static String TRADE_TYPE_QQ = "QQ";                    // QQ钱包支付
        public final static String TRADE_TYPE_JD = "JD";                    // 京东支付
        public final static String TRADE_STATUS_SUCCESS = "SUCCESS";        // 交易成功

        public final static String NOTIFY_TYPE_QQ = "QQ";                    // QQ钱包回调
        public final static String NOTIFY_TYPE_JD = "JD";                    // 京东回调
        public final static String NOTIFY_TYPE_WX = "WX";                    // 微信回调
        public final static String NOTIFY_TYPE_AL = "AL";                    // 支付宝回调
    }
