...
CREATE TABLE `t_pay_order` (
  ...
  `Status` tinyint(6) NOT NULL DEFAULT '0' COMMENT '支付状态,0-订单生成,1-支付中,2-支付成功,3-业务处理完成',
  ...
  `ChannelNotifyData` varchar(2048) DEFAULT NULL COMMENT '渠道回调数据',
...
CREATE TABLE `t_mch_notify` (
  ...
  `NotifyData` varchar(2048) DEFAULT NULL COMMENT '通知数据',
  `NotifyCount` tinyint(6) NOT NULL DEFAULT 0 COMMENT '通知次数',
