...
public class Mq4RefundNotify extends BaseService4RefundOrder {
    ...
    @Autowired
    private IPayChannel4TenService iPayChannel4TenService;
    ...
    public void receive(String msg) {
        ...
        } else if (PayConstant.CHANNEL_NAME_XTENPAY.equalsIgnoreCase(channelName)) {
            resultMap = iPayChannel4TenService.doTenRefundReq(jsonParam);
        }else {
